...
describe '#Animal' do
  ...
  describe('.all') do
    it("returns an array of all animals") do
      animal1 = Animal.new({:id => nil, :name => "Sammy", :type => "Dog", :breed => "Hot Dog", :gender => "Male", :date_admit => "2019-01-01 00:00:00", :owner_id => nil})
      animal2 = Animal.new({:id => nil, :name => "Davis", :type => "Cat", :breed => "Zalbino", :gender => "Female", :date_admit => "2020-02-02 00:00:00", :owner_id => nil})
      animal1.save()
      animal2.save()
  ...
  describe('.all_by_breed') do
    it("returns an array of animals organized by breed") do
      animal1 = Animal.new({:id => nil, :name => "Sammy", :type => "Dog", :breed => "ZzzHot Dog", :gender => "Male", :date_admit => "2019-01-01 00:00:00", :owner_id => nil})
      animal2 = Animal.new({:id => nil, :name => "Davis", :type => "Cat", :breed => "Albino", :gender => "Female", :date_admit => "2020-02-02 00:00:00", :owner_id => nil})
      animal1.save()
      animal2.save()
  ...
  describe('.all_by_date') do
    it("returns an array of animals organized by date, longest first") do
      animal1 = Animal.new({:id => nil, :name => "Sammy", :type => "Dog", :breed => "ZzzHot Dog", :gender => "Male", :date_admit => "2020-01-01 00:00:00", :owner_id => nil})
      animal2 = Animal.new({:id => nil, :name => "Davis", :type => "Cat", :breed => "Albino", :gender => "Female", :date_admit => "2000-02-02 00:00:00", :owner_id => nil})
      animal1.save()
      animal2.save()
      expect(Animal.all_by_date).to(eq([animal2, animal1]))
    end
  end
